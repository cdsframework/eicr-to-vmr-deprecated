...
<div class="jumbotron">
    <div class="container">
        <h2>EICR to VMR ID Randomzier</h2>
        <p>Add eICR message files to upload. This randomizer will read the uploaded message(s) and randomize all 'id' elements to ensure they are all unique</p>
        <p><c:out value="${msg}" /></p>
        <form:form method="post" action="randomizing" enctype="multipart/form-data">
        ...
        <!--<input class="btn btn-md btn-info" id="addFile" type="button" value="Add File" />-->
